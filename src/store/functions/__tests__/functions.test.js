import {
  ...
  mlSoldIncrementCond,
  oneSoldOneReturn,
  oneSoldOneReturnCond,
} from "../function";
import {
  returnProduct,
  returnProductML,
  returnProductBigML,
  returnProductBigMLWithFlacon,
  initialCommandeEqual,
  initialCommandeMinus,
  returnProductAdd,
  initialCommandeAdd,
  initialCommandeMLEqual,
  initialCommandeBigML,
  initialCommandeSmallML,
  initialCommandeBigSmallML,
  initialCommandeBigBigML,
} from "../mocks/products/return/mock-return-product";
...
import {
  ...
  mockDataError3,
  mockDataError4,
} from "../mocks/products/mock-data-error";
import { CanBuy1 } from "../mocks/products/can-by";
import {
  hasCondValAndHasAnyCCStockProductReturn,
  hasCondValAndHasAnyCCStockProductReturnBig,
  hasCondValAndHasAnyCCStockProductReturnSmall,
  initialCommandeDataPhyto,
  initialCommandeDataPhytoSup,
  initialCommandeMLBigTikazBig,
  initialCommandeMLBigTikazEqual,
  initialCommandeMLBigTikazSmallX,
  productDataPhyto,
  productDataPhytoAdd,
  productDataPhytoWhen
} from "../mocks/products/return/mock-return-phyto-product";
/*
describe("Buy system", () => {
...
describe("retirer de commande", () => {
  it("should verify 1 vendu,1 return, equal product == initialcommande", () => {
    let productBuy = copy(returnProduct);
    expect(oneSoldOneReturn(productBuy, initialCommandeEqual)).toStrictEqual({
      etat: "same-qtt",
      initialCommande: {
        datePer: "2021-11-30",
        createdAt: "2021-11-26",
  ...
  it("should verify 1 vendu,1 return, equal initialcommande > product", () => {
    let productBuy = copy(returnProduct);
    expect(oneSoldOneReturn(productBuy, initialCommandeMinus)).toStrictEqual({
      etat: "minus-qtt",
      initialCommande: {
        datePer: "2021-11-30",
        createdAt: "2021-11-26",
  ...
  it("should verify 1 vendu,1 return, equal initialcommande > product,mortis bloc", () => {
    let productBuy ={
      id: 232,
      name: 'MORTIS  BLOC',
      type: 'UNITE',
    ...
    expect(mlSoldIncrement(productBuy, initialCommandeMinus)).toStrictEqual({
      etat: "minus-qtt",
      initialCommande: {
        id: 232,
        name: 'MORTIS  BLOC',
  ...
  it("should verify 1 vendu,1 return, equal initialcommande < product", () => {
    let productBuy = copy(returnProductAdd);
    expect(oneSoldOneReturn(productBuy, initialCommandeAdd)).toStrictEqual({
      etat: "add-qtt",
      initialCommande: {
        datePer: "2021-11-30",
        createdAt: "2021-11-26",
  ...
  it("20 ML, reste ML < doseDefault,+20, is equal", () => {
    let productBuy = copy(returnProductML);
    expect(mlSoldIncrement(productBuy, initialCommandeMLEqual)).toStrictEqual({
      etat: "same-qtt-cc",
      initialCommande: {
        datePer: "2021-11-30",
        createdAt: "2021-11-26",
  ...
  it(" 44 + reste ML > dosedefault  qttbrute +1, qttcc = quantityCCCVA + qttByCC - doseDefault,is small", () => {
    let productBuy = copy(returnProductML);
    expect(mlSoldIncrement(productBuy, initialCommandeSmallML)).toStrictEqual({
      etat: "minus-qtt-cc",
      initialCommande: {
        datePer: "2021-11-30",
        createdAt: "2021-11-26",
  ...
  it("90 + reste ML > dosedefault  qttbrute +1, qttcc = quantityCCCVA + qttByCC - doseDefault,is big", () => {
    let productBuy = copy(returnProductML);
    expect(mlSoldIncrement(productBuy, initialCommandeBigML)).toStrictEqual({
      etat: "minus-qtt-cc",
      initialCommande: {
        datePer: "2021-11-30",
        createdAt: "2021-11-26",
  ...
  it("20 + reste ML > dosedefault  qttbrute +1, qttcc = quantityCCCVA + qttByCC - doseDefault,is small big", () => {
    let productBuy = copy(returnProductML);
    expect(
      mlSoldIncrement(productBuy, initialCommandeBigSmallML)
    ).toStrictEqual({
      etat: "add-qtt-cc",
      initialCommande: {
        datePer: "2021-11-30",
  ...
  it("90 + reste ML > dosedefault  qttbrute +1, qttcc = quantityCCCVA + qttByCC - doseDefault,is big big", () => {
    let productBuy = copy(returnProductML);
    expect(mlSoldIncrement(productBuy, initialCommandeBigBigML)).toStrictEqual({
      etat: "add-qtt-cc",
      initialCommande: {
        datePer: "2021-11-30",
        createdAt: "2021-11-26",
  ...
  /*
  it("1 flacon + 20 ML , 20 + reste ML > dosedefault  qttbrute +1, qttcc = quantityCCCVA + qttByCC - doseDefault", () => {
    let productBuy = copy(returnProductBigMLWithFlacon);
    expect(mlSoldIncrement(productBuy,initialCommande)).toStrictEqual({
      datePer: "2021-11-30",
      createdAt: "2021-11-26",
      id: 1,
      name: "CLOSANTEL 5% 100ML",
  ...
  it("should verify 1 vendu,1 return", () => {
    let productBuy = copy(returnProduct);
    expect(mlSoldIncrement(productBuy,initialCommande)).toStrictEqual({
      datePer: "2021-11-30",
      createdAt: "2021-11-26",
  ...
  it("tikaz cc big and same value", () => {
    let productBuy = copy(hasCondValAndHasAnyCCStockProductReturn);
    expect(
      mlSoldIncrementCond(productBuy, initialCommandeMLBigTikazBig)
    ).toStrictEqual({
  ...
  it("tikaz cc big and big value", () => {
    let productBuy = copy(hasCondValAndHasAnyCCStockProductReturnBig);
    expect(
      mlSoldIncrementCond(productBuy, initialCommandeMLBigTikazSmallX)
    ).toStrictEqual({
  ...
  it("should verify 1 vendu,1 return, equal product == initialcommande,phyto", () => {
    let productBuy = copy(productDataPhyto);
    expect(
      oneSoldOneReturnCond(productBuy, initialCommandeDataPhyto)
    ).toStrictEqual({
      etat: "same-qtt-cond",
      initialCommande: {
        datePer: "2021-11-30",
  ...
  it("should add phyto equal product < initialcommande,phyto", () => {
    let productBuy = copy(productDataPhyto);
    expect(
      oneSoldOneReturnCond(productBuy, initialCommandeDataPhytoSup)
    ).toStrictEqual({
      etat: "minus-qtt-cond",
      initialCommande: {
        datePer: "2021-11-30",
  ...
  it("should add phyto equal product > initialcommande,phyto", () => {
    let productBuy = copy(productDataPhytoAdd);
    expect(
      oneSoldOneReturnCond(productBuy, initialCommandeDataPhyto)
    ).toStrictEqual({
      etat: "add-qtt-cond",
...
/**  it(" has flacon , should add phyto equal product > initialcommande,phyto", () => {
    let productBuy = copy(productDataPhytoWhen);
    expect(
      oneSoldOneReturnCond(productBuy, initialCommandeDataPhyto)
    ).toStrictEqual({
      etat: "add-qtt-cond",
  ...
  /**it("tikaz cc small", () => {
    let productBuy = copy(hasCondValAndHasAnyCCStockProductReturnSmall);
    expect(mlSoldIncrementCond(productBuy)).toStrictEqual({
      product: {
        datePer: "2021-11-30",
        createdAt: "2021-11-26",
        id: 1,
